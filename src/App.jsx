              ...
              <>
                <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <div>
                    ...
                    <input type="tel" value={phone} onChange={e => setPhone(e.target.value)} onBlur={() => setPhoneTouched(true)} placeholder="+43..." style={{ ...iS, borderColor: phoneTouched && !phoneOk(phone) ? "rgba(224,82,82,0.6)" : "rgba(240,235,224,0.12)" }} />
